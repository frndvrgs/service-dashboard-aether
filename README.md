...
```
aws elasticbeanstalk update-environment --environment-name service-dashboard-aether-env --option-settings file://.env.aws.json
aws elasticbeanstalk describe-environments --environment-names service-dashboard-aether-env
```
